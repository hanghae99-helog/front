                ...
                <TitleBody>
                    ...
                    <WritingButtons>
                        <button onClick={() => {
                            ...
                            navigate(`/posting/${data.postId}`, {state: {...data}});
                            }}>수정</button>
                            ...
                            <Modal>
                                <DeleteModal>
                                    ...
                                    <div className="modalBtns">
                                        <button className="cansle" onClick={ModalDown}>취소</button>
                                        <button className="submit" onClick={deletePost}>확인</button>
                                    </div>
                                </DeleteModal>
                            </Modal>
                        )}
